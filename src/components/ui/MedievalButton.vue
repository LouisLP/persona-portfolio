...
<template>
  <button :class="buttonStyles" :disabled="disabled || loading" @click="handleClick">
    ...
    <div class="pointer-events-none absolute inset-0">
      <!-- Top Left Corner -->
      <div class="absolute top-0 left-0 h-2 w-2" :class="[cornerStyles]" />
      <div class="absolute top-0 left-0 h-3 w-1" :class="[cornerStyles]" />
      <div class="absolute top-0 left-0 h-1 w-3" :class="[cornerStyles]" />

      <!-- Top Right Corner -->
      <div class="absolute top-0 right-0 h-2 w-2" :class="[cornerStyles]" />
      <div class="absolute top-0 right-0 h-3 w-1" :class="[cornerStyles]" />
      <div class="absolute top-0 right-0 h-1 w-3" :class="[cornerStyles]" />

      <!-- Bottom Left Corner -->
      <div class="absolute bottom-0 left-0 h-2 w-2" :class="[cornerStyles]" />
      <div class="absolute bottom-0 left-0 h-3 w-1" :class="[cornerStyles]" />
      <div class="absolute bottom-0 left-0 h-1 w-3" :class="[cornerStyles]" />

      <!-- Bottom Right Corner -->
      <div class="absolute right-0 bottom-0 h-2 w-2" :class="[cornerStyles]" />
      <div class="absolute right-0 bottom-0 h-3 w-1" :class="[cornerStyles]" />
      <div class="absolute right-0 bottom-0 h-1 w-3" :class="[cornerStyles]" />
    </div>
