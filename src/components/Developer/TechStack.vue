  ...
  <div class="relative space-y-6">
    ...
    <div class="flex flex-wrap justify-center gap-6">
      <div
        ...
        :key="item.name"
        class="group relative flex size-48 cursor-pointer items-center justify-center rounded-xl border border-gray-700/50 bg-gradient-to-br from-gray-800 to-gray-900 shadow-inner transition-all duration-300 hover:scale-[101%] hover:shadow-lg"
        style="
          box-shadow:
        ...
        @click="openDocumentation(item.url)"
      >
        <!-- SVG Icon -->
        <svg
          role="img"
          ...
          class="size-16 transition-all duration-100"
        >
        ...
        >
          ...
          <p class="mt-2 text-xs text-gray-400">Click to view docs</p>
        </div>
      </div>
    </div>
  </div>
