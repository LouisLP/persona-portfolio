...
import type { PersonaType } from '@/stores/persona'
...
async function switchPersona(persona: PersonaType) {
  ...
  >
    ...
    >
      <button
        ...
        :style="personaStore.currentPersona === persona.type
          ? { backgroundColor: `${personaStore.theme.primary}66` }
          : {}"
